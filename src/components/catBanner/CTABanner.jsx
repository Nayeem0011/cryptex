...
const CTABanner = () => {
    ...
    useGSAP(() => {
        ...
        // 1. Heading — scale+fade, impactful entrance
        tl.fromTo(
            headingRef.current,
    ...
    return (
        <div ref={sectionRef} className='cta-banner'>
            <svg className="absolute inset-0 w-full h-full pointer-events-none px-4" viewBox="0 0 1191 398" preserveAspectRatio="none"
                ...
                <g opacity="0.25" filter="url(#filter1_f_2509_2476)">
                    <ellipse cx="595.725" cy="198.967" rx="464.908" ry="256.15" fill="#613AD4" fillOpacity="0.7" />
                </g>
                <defs>
                    <filter id="filter0_f_2509_2476" x="136.806" y="-169.788" width="1011.05" height="739.892" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                        <feFlood flood-opacity="0" result="BackgroundImageFix" />
                        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                        <feGaussianBlur stdDeviation="87.7333" result="effect1_foregroundBlur_2509_2476" />
                    </filter>
                    <filter id="filter1_f_2509_2476" x="-260.85" y="-448.849" width="1713.15" height="1295.63" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                        <feFlood flood-opacity="0" result="BackgroundImageFix" />
                        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                    ...
                    <linearGradient id="paint0_linear_2509_2476" x1="262.212" y1="200.158" x2="1022.45" y2="200.158" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#4F2AC0" />
                        <stop offset="1" stopColor="#8B65FE" />
                    </linearGradient>
                </defs>
            </svg>
            <div className='cta-banner-inner'>
                <h1 ref={headingRef} className='cta-banner-title'>
