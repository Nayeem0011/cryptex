            ...
            <div className='tokenomics'>
                <div className='tokenomics-section'>
                    <div className='tokenomics-section-inner'>
                        <div className='flex flex-col gap-[39.17px]'>
                            <div className='flex flex-col gap-[13.8px]'>
                                ...
                                <p className='tokenomics-section-desc'>
                                    Provides businesses with the opportunity to design and implement <br className="hidden lg:block" /> robust tokenomics models without the burden of high costs. <br className="hidden lg:block" /> By removing financial barriers.
                                </p>
                            </div>
