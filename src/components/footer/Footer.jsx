const Footer = () => {
    return (
        <div className='w-full max-w-[1550px] mx-auto pt-35.25 pb-[24.49px]'>
            <div className='flex items-center justify-between pb-[37.6px]'>
                <div className='flex flex-col gap-11.75'>
                    <div className='flex items-center gap-[37.6px]'>
                        <p className='font-medium text-[15.67px] leading-[140%] tracking-[0%] text-[#D0D1E3]'>
                            Products
                        </p>
                        <p className='font-medium text-[15.67px] leading-[140%] tracking-[0%] text-[#D0D1E3]'>
                            Tokenomics
                    ...
                    <div className='flex gap-[12.53px]'>
                        <button className='rounded-[47px] px-[25.07px] py-[14.1px] gap-[7.83px] bg-[linear-gradient(180deg,#4E27BC_0%,#A68AF9_100%)] font-medium text-[15.67px] leading-[130%] tracking-[0%] text-center text-[#FFFFFF] cursor-pointer'>
                            Request Audit
                        </button>
                        <button className="relative flex items-center justify-center w-[48.57px] h-[48.57px] rounded-full bg-[#FFFFFF0D]">
                            {/* Gradient border */}
                            <div
                                className="absolute inset-0 rounded-full pointer-events-none"
                                style={{
                                    padding: '0.78px',
                                    background: 'linear-gradient(180deg, #2D2F42 0%, rgba(34,35,56,0) 100%)',
                ...
                <div className='flex flex-col gap-[28.2px]'>
                    <p className='font-medium text-[18.8px] leading-[140%] tracking-[0%] text-[#D0D1E3]'>
                        Subscribe
                    </p>
                    <div className="flex items-center justify-between border-b-[0.78px] border-b-[#25214D] w-[335.27px] py-[15.67px]">
                        <input
                            type="email"
                            placeholder="Enter your email"
                            className="bg-transparent outline-none placeholder-[#8B899E] font-normal text-[15.67px] leading-[120%] tracking-[0%] text-[#7F8799] w-full"
                        />
            ...
            <div className='w-full border-t-[0.78px] border-transparent [border-image:linear-gradient(90deg,rgba(34,35,56,0)_0%,#302A61_50.16%,rgba(34,35,56,0)_100%)_1]'></div>
            <div className='flex items-center justify-between pt-[18.18px]'>
                <p className='font-normal text-[14.1px] leading-[140%] tracking-[0%] text-[#7F8799]'>
                    &copy; CryptEx. All rights reserved.
                </p>
                <div className='flex items-center gap-[31.33px]'>
                    <p className='font-normal text-[14.1px] leading-[140%] tracking-[0%] text-[#7F8799]'>
