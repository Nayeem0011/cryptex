            ...
            <div className='footer-row'>
                <div ref={linksButtonsRef} className='footer-links-buttons'>
                    ...
                    <div className="footer-socials">
                        ...
                        <div className='flex gap-[12.53px]'>
                            <button className="footer-social-btn group">
                                {/* Gradient border */}
                                <div className="footer-social-btn-border" />
                                <svg className="w-4.5 md:w-5 lg:w-5.25 xl:w-5.5 2xl:w-5.75 transform transition-transform duration-300 ease-out group-hover:scale-110" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div ref={subscribeRef} className='footer-subscribe'>
                    ...
                    <div className="footer-subscribe-wrap">
                        ...
                        />
                        <button className="footer-subscribe-btn group">
                            <svg className="w-5.5 sm:w-6 md:w-6.5 lg:w-7 xl:w-7.5 2xl:w-8 transition-transform duration-300 ease-out group-hover:translate-x-1" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" >
